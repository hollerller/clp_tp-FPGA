...
HD_PWD='C:/Users/davle/Documents/UBA/CESE/CLP/Codigos/clp_tp-FPGA/Guia_VHDL/18-contBCD1seg/synth/contBCD1seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log contBCD1seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source contBCD1seg.tcl -notrace

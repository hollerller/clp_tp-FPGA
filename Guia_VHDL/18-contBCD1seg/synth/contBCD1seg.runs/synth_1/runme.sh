...
HD_PWD='C:/Users/davle/Documents/UBA/CESE/CLP/Codigos/clp_tp-FPGA/Guia_VHDL/18-contBCD1seg/synth/contBCD1seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log contBCD1seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source contBCD1seg.tcl

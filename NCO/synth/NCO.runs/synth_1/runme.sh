...
HD_PWD='C:/Users/davle/Documents/UBA/CESE/CLP/Codigos/clp_tp-FPGA/NCO/synth/NCO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NCO_ILA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NCO_ILA.tcl

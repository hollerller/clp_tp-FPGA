...
HD_PWD='C:/Users/davle/Documents/UBA/CESE/CLP/Codigos/clp_tp-FPGA/NCO/synth/NCO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NCO_ILA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NCO_ILA.tcl -notrace
